...
**1**можно создавать программы различных конфигураций.
**2**Приводит к эффективному использованию памяти, так как ненужный код не хранится в памяти во время выполнения.
**3**Решение о включении той или иной части программы принимается на этапе компиляции, а не во время выполнения. Это повышает эффективность программы
